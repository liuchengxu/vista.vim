...
function! vista#renderer#LSPProcess(processed_data, reload_only, should_display) abort
  if a:should_display
    call vista#debugging#Log('[LSPProcess]should_display, processed_data:'.string(a:processed_data))
    call vista#renderer#RenderAndDisplay(a:processed_data)
    return [a:reload_only, v:false]
  else
    call vista#debugging#Log('[LSPProcess]reload_only, processed_data:'.string(a:processed_data))
  ...
  elseif a:should_display
    ...
    call vista#debugging#Log('[LSPProcess]doing nothing')
